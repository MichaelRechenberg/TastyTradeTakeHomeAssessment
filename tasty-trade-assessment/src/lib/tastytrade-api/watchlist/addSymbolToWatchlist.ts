...
export const addSymbolToWatchlist = (sessionToken: string) => async (addSymbolToWatchlistInput: AddSymbolToWatchlistInput): Promise<AddSymbolToWatchlistOutput> => {
    ...
    const addSymbolToWatchlistResponse = await fetch(`${TastyTradeApiBaseURL}/watchlists/${watchlistName}`, {
        method: "PUT",
        headers,
